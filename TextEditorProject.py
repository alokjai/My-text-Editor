...
main_app.title('Alopad text editor')
...
font_finaly = tk.StringVar()
font_box = ttk.Combobox(toolbar, width=30,textvariable=font_finaly, state='readonly')
...
## size box
size_var = tk.IntVar()
font_size = ttk.Combobox(toolbar,width=12, textvariable = size_var, state='readonly')
...
def change_font(event=None):
    ...
    current_font_family = font_finaly.get()
...
def change_font_color():
    ...
    #print(color_var)
    text_editor.configure(fg=color_var[1]) # fg === forground 

font_color_btn.configure(command=change_font_color)

# align_left button functionality
def align_left():
    text_content = text_editor.get(1.0,'end') # first position se end tak sabhi text ko get karna
...
# align_center button functionality
def align_center():
    text_content = text_editor.get(1.0,'end') # first position se end tak sabhi text ko get karna
...
# align_right button functionality
def align_right():
    text_content = text_editor.get(1.0,'end') # first position se end tak sabhi text ko get karna
